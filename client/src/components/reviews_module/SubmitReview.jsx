  ...
  return !showReviewModal ? (
    ...
    <div id="review-window">
      <div id="review-form" onSubmit={(e) => e.preventDefault()}>
        ...
        <h1 id="add-review-header">Write Your Review</h1>
        ...
        <fieldset id="recommend" required="required">
          <legend id="user-recommend">Do you recommend this product?*</legend>
        ...
        <fieldset id="review-summary-input">
          <legend className="user-summary-heading">Summary</legend>
          <textarea
        ...
        <fieldset id="email-input">
          <legend className="user-review-email">Your email*</legend>
          <input
        ...
        <span className="review-field-required">*required</span>
      </div>
      <ErrorModal
        error={error}
